---
name: moment-scout
description: 'ClipForge Moment Scout. Use after signal peaks are computed to pick standalone short-clip candidates with exact hook start / payoff end. Input: campaign, clip_length, peaks.'
tools: Read, Glob, Grep
model: sonnet
---
<!-- GENERATED from agents/moment_scout.md by `python -m clipforge.claude_agents`. Do not edit here. -->
...
If `agents/exemplars/moment_scout.md` exists, read it first and calibrate against it.
...
{"$defs": {"Candidate": {"properties": {"id": {"title": "Id", "type": "string"}, "start": {"minimum": 0, "title": "Start", "type": "number"}, "end": {"exclusiveMinimum": 0, "title": "End", "type": "number"}, "hook_line": {"description": "Exact words said in the first seconds of the clip", "title": "Hook Line", "type": "string"}, "payoff": {"title": "Payoff", "type": "string"}, "score": {"maximum": 100, "minimum": 0, "title": "Score", "type": "integer"}, "reason": {"title": "Reason", "type": "string"}, "signal_peak_ids": {"default": [], "items": {"type": "string"}, "title": "Signal Peak Ids", "type": "array"}}, "required": ["id", "start", "end", "hook_line", "payoff", "score", "reason"], "title": "Candidate", "type": "object"}}, "properties": {"candidates": {"items": {"$ref": "#/$defs/Candidate"}, "title": "Candidates", "type": "array"}}, "required": ["candidates"], "title": "MomentScoutOut", "type": "object"}
